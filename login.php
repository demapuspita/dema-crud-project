...
<body>
  ...
  <a class="navbar-brand" href="#" style="font-size:30px;"><strong>UTDI</strong></a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="https://wa.me/+6281292364808">WhatsApp</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="https//instagram.com/demapuspitaa">Instagram</a>
        </div>
      </li>
    </ul>
  ...
  <img class="card-img-top mx-auto" src="images/admin-icon-png-9.jpg" style="width: 50%; " alt="Card image cap">
  <div class="card-body">
 ...
 <button type="submit" class="btn btn-warning"><i class="fa fa-lock">&nbsp;</i> Masuk</button> &nbsp; &nbsp; 
