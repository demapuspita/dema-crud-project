...
<nav class="navbar navbar-light bg-light">
  ...
  <a href="logout.php" class="btn btn-primary"><i class="fa fa-lock-open"></i> Keluar </a>
    </form>
</nav>
    <p>
    ...
    <div class="page-header">
        <h1>Hi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>Selamat di Website kami</h1>
    </div>
    <hr>
    </div>
        <a href="reset-password.php" class="btn btn-warning">Atur Ulang Password</a>
